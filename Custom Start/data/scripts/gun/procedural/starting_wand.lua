...
function spell_action()
    local spell = tostring(ModSettingGet("Custom_Start.primary_spell") or "1")
    local spell_map = {
        ["1"] = "ACIDSHOT",
        ["2"] = "BLACK_HOLE",
    ...
    print("Debug: Selected spell for primary wand: " .. tostring(selected_spell))
...
local gun = {
    name = {"Primary Wand"},
    actions_per_round = 1,
    reload_time = tonumber(ModSettingGet("Custom_Start.primary_cast_delay") or 20), -- Adjusted for cast delay
    shuffle_deck_when_empty = 0,
    fire_rate_wait = tonumber(ModSettingGet("Custom_Start.primary_recharge_time") or 15), -- Adjusted for recharge time
    spread_degrees = 0,
    speed_multiplier = 1,
    mana_charge_speed = tonumber(ModSettingGet("Custom_Start.primary_mana_charge_speed") or 20),
    mana_max = tonumber(ModSettingGet("Custom_Start.primary_mana_max") or 100)
}

-- Set the wand's properties
ComponentSetValue(ability_comp, "ui_name", "Primary Wand")
...
local action_count = math.min(
    tonumber(ModSettingGet("Custom_Start.primary_spell_count") or 1),
    tonumber(ModSettingGet("Custom_Start.primary_deck_capacity") or 1)
)
